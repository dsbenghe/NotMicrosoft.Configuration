...
namespace Microsoft.Extensions.Configuration.Json.Test
{
    public class ArrayTest
    {
        ...
        public void ImplicitArrayItemReplacement()
        {
            ...
            var jsonConfigSource1 = new JsonTemplateConfigurationSource { FileProvider = TestStreamHelpers.StringToFileProvider(json1) };
            var jsonConfigSource2 = new JsonTemplateConfigurationSource { FileProvider = TestStreamHelpers.StringToFileProvider(json2) };
